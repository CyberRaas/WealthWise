...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      {
        value: "conservative",
        label: "I prefer safety over returns",
        score: 1,
      },
      {
        value: "moderate",
        label: "I can accept some risk for better returns",
        score: 2,
      },
      {
        value: "aggressive",
        label: "I am comfortable with high risk for high returns",
        score: 3,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "moderate",
        label: "Fairly stable with some variation",
        score: 2,
      },
  ...
  },
  {
    ...
    description:
      "Money set aside for unexpected expenses (3-6 months expenses)",
    options: [
  ...
  },
  {
    ...
    description:
      "Have you invested in stocks, mutual funds, or other assets before?",
    options: [
      ...
      {
        value: "experienced",
        label: "Experience with stocks and diverse assets",
        score: 4,
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "sellAll",
        label: "Sell everything to prevent further losses",
        score: 1,
      },
...
const PROFILE_DESCRIPTIONS = {
  conservative:
    "You prefer stability and capital protection. Your portfolio focuses on government securities and fixed-income instruments.",
  moderate:
    "You balance growth with stability. Your portfolio includes a mix of equity and fixed-income investments.",
  aggressive:
    "You seek higher returns and can tolerate market volatility. Your portfolio emphasizes equity investments.",
};
    ...
    return (
      ...
      >
        <Card className="text-center py-8">
          <CardContent>
            <div
              className={`w-20 h-20 mx-auto ${profileColor} rounded-full flex items-center justify-center mb-4`}
            >
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-2">
                  {result.suggestedAllocation &&
                    Object.entries(result.suggestedAllocation).map(
                      ([asset, percentage]) => (
        ...
        <Card className="bg-yellow-50 border-yellow-200 dark:bg-yellow-950/20 dark:border-yellow-800">
          <CardContent className="p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              This assessment is for educational purposes only. It does not
              constitute investment advice. Please consult a SEBI-registered
