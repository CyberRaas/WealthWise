...
// Initialize Groq AI (handled in groqClient but we can check key here if needed)
// const groq = groq; 
...
Response in JSON format:
{
  ...
  "motivationalNote": "Brief encouraging note"
    ...
    const completion = await groq.chat.completions.create({
      messages: [
        { role: 'system', content: 'You are a financial education assistant. Return valid JSON only.' },
