...
3. **shopping**: Clothes, accessories, electronics, online shopping
   - Keywords: कपड़े, shoes, शूज, जूते, amazon, flipkart, mall, नया (new)
   - Actions: खरीदा, लिया, दिया, bought, purchased
   - Example: "नया शूज दिया" → shopping (bought new shoes)
...
EXAMPLES WITH HINDI NUMBERS (LEARN FROM THESE):
✓ "हजार रुपए का नया शूज दिया" → {"amount": 1000, "category": "shopping", "merchant": null, "description": "New shoes", "confidence": 0.95}
✓ "पचास रुपए चाय पी" → {"amount": 50, "category": "food", "merchant": null, "description": "Tea", "confidence": 0.95}
✓ "सौ रुपए का समोसा खाया" → {"amount": 100, "category": "food", "merchant": null, "description": "Samosa", "confidence": 0.95}
...
✓ "हजार रुपए mobile recharge" → {"amount": 1000, "category": "utilities", "merchant": null, "description": "Mobile recharge", "confidence": 0.9}
