...
{
  "explanations": {
    "overall": "Expert validation of this budget (2-3 sentences, mention specific strengths)",
    "categories": {
      "food_dining": "Why ₹${categories.food_dining?.amount || 0} is realistic for ${familySize} members in ${city}",
      ...
      "entertainment": "Lifestyle balance commentary",
  ...
  "tips": [
    ...
    "🎯 One actionable habit to start this month"
  ],
  "recommendations": [
    {
      "type": "Emergency Fund",
