...
USER DATA:
- Monthly Income: ${totalBudget > 0 ? '₹' + totalBudget.toLocaleString('en-IN') : 'Not Set (User has not entered income)'}
- Spent This Month: ₹${totalSpent.toLocaleString('en-IN')}
- Savings This Month: ₹${savings.toLocaleString('en-IN')}
...
- If Income is "Not Set", DO NOT generate "No Income" warnings. Instead, gently suggest "Set Up Your Budget" as a recommendation.
