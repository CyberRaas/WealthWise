...
class EmailService {
  ...
  async sendWelcomeEmail(user) {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Thank you for joining WealthWise . We're excited to help you take control of your finances and achieve your financial goals.</p>
            ...
            <p>Our AI-powered assistant is ready to help you make WealthWise  decisions every step of the way.</p>
            
            <a href="${process.env.NEXTAUTH_URL}/dashboard" class="button">Get Started</a>
          </div>
          <div class="footer">
            <p>Happy budgeting!<br>The WealthWise  Team</p>
          </div>
        </div>
      </body>
      </html>
    ...
    const text = `
      ...
      Thank you for joining WealthWise . We're excited to help you take control of your finances and achieve your financial goals.
