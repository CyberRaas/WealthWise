# 🎤 Mumbai Hacks 2024 - Pitch Deck Outline

**WealthWise: Autonomous Financial Coach for Gig Workers**
...
┌─────────────────────────────────────────┐
│ Assume Fixed Salary                     │
│ → 150M gig workers have variable income │
├─────────────────────────────────────────┤
│ English-Only + Complex UI               │
│ → Low financial literacy, prefer voice  │
├─────────────────────────────────────────┤
│ Require Bank Account Linking            │
│ → Privacy concerns, informal sector     │
├─────────────────────────────────────────┤
│ Reactive (Post-Spending Analysis)       │
│ → Need PROACTIVE coaching               │
└─────────────────────────────────────────┘
```
...
├─────────────────────────────────────────┤
│ 🎤 Voice-First (Hindi/Hinglish)         │
│    "₹500 petrol bharwaya" → Tracked!   │
├─────────────────────────────────────────┤
│ 🔒 Privacy-First (No Bank Linking)      │
│    Manual + voice entry only            │
├─────────────────────────────────────────┤
...
✅ Hindi/Hinglish processing
✅ Auto-categorization
✅ Added to budget

HIGHLIGHT: "No typing needed - perfect for delivery workers on the go!"
```
...
SHOW:
⚠️ Agent Alert Pops Up:
"Wait! Pattern detected:
• You've spent ₹800 on food already today
• Your average: ₹300/day
• Budget impact: ₹1,300 (OVER by 60%)

💡 Alternatives:
• Cook at home → Save ₹700
• Local dhaba → Save ₹400
• Proceed anyway"

[User taps "Cook at home"]

✅ Agent: "Smart choice! ₹700 saved → Closer to Goa trip goal! 🎯"

HIGHLIGHT: "This is PROACTIVE coaching - prevents mistakes BEFORE they happen!"
```
...
• Week 1: ₹12,000 (High)
• Week 2: ₹8,000 (Medium)
• Week 3: ₹5,000 (Low - Festival week)
• Week 4: ₹9,500 (Medium)

SHOW: Agent Auto-Actions
✅ Flex Budget activated (detected 40% variability)
✅ Week 1: "Great week! Auto-saved ₹3,500 for buffer"
✅ Week 3: "Low income week. Using buffer. Essentials covered ✅"
✅ Month end: "Despite variability, you saved ₹6,200 (18%)!"

HIGHLIGHT: "The system adapted to his income 47 times this month—fully autonomous!"
```
...
├─────────────────────────────────────────────┤
│ ✅ INCOME VARIABILITY FOCUS                 │
│    ONLY app built for gig workers           │
│    Flex budgets that adapt daily            │
├─────────────────────────────────────────────┤
│ ✅ VOICE-FIRST IN HINDI/HINGLISH            │
│    No typing needed                         │
...
│    20+ cities, festivals, family dynamics   │
└─────────────────────────────────────────────┘
```
...
├─────────────────────────────────────┤
│ 👥 150M+ Gig Workers                │
│ 💰 ₹4.2 Lakh Crore Market Size      │
│ 📈 17% Annual Growth                │
├─────────────────────────────────────┤
│ Addressable Market:                 │
│ • 50M smartphone users              │
│ • 80% have variable income          │
│ • 0% currently use budgeting apps   │
└─────────────────────────────────────┘

TAM: ₹2,100 Cr (@ ₹99/month, 10% penetration)
```
...
┌─────────────────────────────────────┐
│ 💰 Savings Increase: +42%           │
│ 🛡️ Emergency Buffer: 73% built one  │
│ ⚠️ Bill Defaults: -85%              │
│ 🎯 Goal Achievement: +38%           │
...
Q1 2026 (Prototype → MVP)
├─ Launch in Mumbai, Delhi, Bangalore
├─ 10,000 active users
└─ Partner with Uber, Swiggy for acquisition

Q2 2026 (Scale)
├─ Pan-India expansion
├─ 100,000 users
└─ B2B partnerships (fleet operators)

Q3 2026 (Monetization)
├─ Freemium model launch
├─ Premium: ₹99/month (advanced features)
└─ Break-even at 50,000 paying users

Q4 2026 (Vision)
├─ 1M users
├─ Expand to informal sector (maids, shopkeepers)
...
✅ Pilot Opportunities
   10,000 user pilot with gig platforms

✅ Seed Funding (Future)
   To scale tech team & marketing

📧 Contact: team@wealthwise.tech
...
- **End**: Determined (We're going to scale this!)
...
✅ They ask about next steps (serious consideration)
...
❌ Defensive answers to questions (seems unprepared)
❌ Claiming features you don't have (dishonest)
...
4. **You have a working prototype (huge advantage!)**
...
**YOU'VE GOT THIS! NOW GO WIN MUMBAI HACKS 2024! 🏆**

---

**Document Version**: 1.0  
**Last Updated**: October 19, 2025  
**Prepared for**: Mumbai Hacks 2024 Pitch  
**Time Limit**: 5 minutes  
**Goal**: Win Fintech Track 🎯
